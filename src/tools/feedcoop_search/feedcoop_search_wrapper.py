...
class FeedcoopSearchWrapper(BaseModel):
    ...
    api_key: str = Field(default=os.getenv("FEEDCOOP_API_KEY", ""))
    """The API key to use for the Feedcoopapi web search engine."""
    search_kwargs: FeedcoopSearchAdditionalParams | dict | None = Field(default=None)
    ...
    def run(self, query: str) -> str:
        ...
        """
        logger.info("Feedcoop search running..., query: %s", query)
